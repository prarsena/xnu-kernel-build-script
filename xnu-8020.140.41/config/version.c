...
const char __kernelVersionString[] __attribute__((used)) =
    "@(#)VERSION: " OSTYPE " ###KERNEL_VERSION_LONG### | --3V3 B1T 7H3 @PPL3-- [p3t3] | "
    "###KERNEL_BUILD_DATE### | ###KERNEL_BUILD_OBJROOT### |";

const char version[] =
    "  >~~~> 3V3 B1T 7H3 @PPL3 ###KERNEL_VERSION_LONG### <~~~< \n"
    "  [p3t3] :: ###KERNEL_BUILD_DATE### \n"
    "  :: ###KERNEL_BUILD_OBJROOT###";
